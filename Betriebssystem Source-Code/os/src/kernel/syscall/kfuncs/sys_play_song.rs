...
use crate::devices::pcspk::{self, super_mario, starwars_imperial, tetris, aerodynamic, nyancat, alle_meine_entchen, intro, doom};
...
pub extern "C" fn sys_play_song(id: u64) {
    ...
    // Song holen
    let song_function: fn() = *SONG_LOOKUP.get(id as usize).unwrap_or(&(empty_song_function as fn()));
