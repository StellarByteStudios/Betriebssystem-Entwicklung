...
#[no_mangle]
pub extern "C" fn sys_paint_picture_on_pos(x: u64, y: u64, width: u64, height: u64, bbp: u64, bitmapbuff: *const u8) -> i64 {
    // Fehlerabfrage
    ...
    unsafe {
        ...
        // Bitmap ausgeben
        vga::draw_bitmap(x as u32, y as u32, width as u32, height as u32, bitmap, bbp as u32); 
    }
